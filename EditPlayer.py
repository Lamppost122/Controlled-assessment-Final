...
class EditPlayer:
    ...
    Variables:
        players - contain player instances which match the search
        Results - Contains a instance of the player file
        lblFirstName - First Name Heading Label Widget
        lblLastName - Last Name Heading Label Widget
        lblPhoneNumber - Phone Number Heading Label Widget
        lblAddress - Address Heading Label Widget
        lblPostcode - Postcode Heading Label Widget
        lblDateOfBirth - Date of Birth Heading Label Widget
    ...
    def SearchPlayers(self):
        """
        Adds player instance to the player variable that match the search critea
        Search Critera - Matching First Name, Last Name or First Name Last Name combination. Not case sensitive.
        """
        self.players = {}
    ...
    def GetPlayers(self):
        """
        Place found players into a table of entry Widgets
        """
        try:
    ...
    def Edit_Players(self):
        """
        Updates the Player file with new data
        """
...
class EditPlayerAdmin(tk.Frame,EditPlayer):
    ...
    Variables:
        ...
        EditPlayerButton - Edit Player Button Widget
