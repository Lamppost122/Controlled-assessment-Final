...
class ConfirmAvailablity:
    ...
    Methods:
        ...
        ClearMatches
    Variables:
        AvailableMatches - Contain Match instances
        TeamID - Contains the teamID of a given team
        lblText - Match Text Label Widget
        lblResponceStatus - Responce Status Heading Label Widget
        lblResponce - Responce Data Label Widget
        YesButton - Yes Button Widget
        NoButton - No Button Widget
...
class ConfirmAvailablityAdmin(tk.Frame,ConfirmAvailablity):
    ...
    Variables:
        ...
        GetMyMatchesButton -    Get Matches Button Widget
