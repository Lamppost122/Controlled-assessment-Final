...
class AdminCommandsAdmin(tk.Frame,AdminCommands):
    ...
    Variables:
        ...
        lblMatches - Match Heading Label Widget
        lblTeam - Team Heading Label Widget
        lblUpdates - Update Heading Label Widget
        lblBackUp - Back Up Heading Label Widget
        RemovePlayerButton -Remove Player Button Widget
        EditPlayerButton - Edit Player Button Widget
        AddMatchButton - Add Match Button Widget
        RemoveMatchButton - Remove Match Button Widget
        EditMatchButton - Edit Match Button Widget
        AddTeamButton - Add Team Button Widget
        RemoveTeamButton - Remove Team Button Widget
        EditTeamButton - Edit Team Button Widget
        AddUpdateButton - Add Update Button Widget
        BackUpButton - Backup Button Widget
        BackButton Back Button Widget
        ImportDataButton Import Data Button Widget
        lblImportData - Import Data Heading Label Widget
